...
`/Script/CoreUObject.LinearColor` в TextColor). Copy-back дал ground truth:
...
1. **LineTraceByChannel пропадает.** v5: каноника UE4 + `SubCategory=""`, ретест
   J1/J2/J2b/J3a/J3b/J3c/J4/J5/J6/J7. У выживших забрать copy-back (особенно J1 —
   даст истинные энамы/OutHit/массивы). Результат вписать в реестр и в этот файл.
