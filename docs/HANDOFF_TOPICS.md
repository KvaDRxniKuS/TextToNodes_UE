...
Обновление 2026-09-26: получено «28 норма». Также обнаружен дефект раскладки рядов: равное NodePosY/выравнивание по верху не гарантирует одинаковую высоту exec-пинов, если заголовки нод занимают разное число строк. Пример copy-back ClearAllMappings → FlushPlayerInput: одинаковый NodePosY, но у первой ноды двухстрочная шапка/описание и exec-pin ниже. Следующая задача layout: выравнивать цепочку относительно центра exec-пинов; сохранить отдельную калибровку ширины knot по реальному правому краю (R30 PrintString и ожидаемый 27b SetVisibility).
